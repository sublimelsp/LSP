...
1. Install a language server from the [list of language servers](/language_servers/), ensuring it can be started from the command line (is in your PATH).
...
The [list of language servers](/language_servers/) shows installation instructions and example configurations for several servers that have been tested and are known to work with the LSP package.
