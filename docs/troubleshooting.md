...
In LSP Settings enable the `log_debug` setting and `log_payloads` if needed. Restart Sublime and copy the output from the Sublime console to your GitHub issue.
...
### 2. LSP cannot find my language server through PATH on OS-X
