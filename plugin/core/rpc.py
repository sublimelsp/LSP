...
class PreformattedPayloadLogger:
    ...
    def outgoing_request(self, request_id: int, method: str, params: Any) -> None:
        if not self.settings.log_debug:
            return
        self.log(self.format_request(Direction.Outgoing, method, request_id), params, self.settings.log_payloads)
...
class Client(object):
    ...
    def send_request(
        ...
        if self.transport is not None:
            self.logger.outgoing_request(self.request_id, request.method, request.params)
