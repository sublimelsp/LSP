...
class TreeItem:
    ...
    def html(self, sheet_name: str, indent_level: int) -> str:
        ...
        if self.collapsible_state == TreeItemCollapsibleState.COLLAPSED:
            disclosure_button_html = '<a class="disclosure-button" href="{}" title="Expand">&#9205;</a>'.format(
            ...
            disclosure_button_html = '<a class="disclosure-button" href="{}" title="Collapse">&#9207;</a>'.format(
