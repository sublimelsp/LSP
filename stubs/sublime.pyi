...
from typing import Any, Optional, Callable, Sequence, Tuple, Union, List, Sized, Iterable
...
class View:
    ...
    def add_regions(self, key: str, regions: Iterable[Any], scope: str = ..., icon: str = ..., flags: int = ...) -> None:
        ...
