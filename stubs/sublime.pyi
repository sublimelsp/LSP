...
class Window:
    ...
    def show_quick_panel(self, items: List[Any], on_select: Callable, flags: int = ..., selected_index: int = ..., on_highlight: Optional[Callable] = ...) -> None: ...
...
class View:
    ...
    def find_all(self, pattern: str, flags: int = ..., fmt: Optional[Any] = ..., extractions: Optional[Any] = ...) -> 'List[Region]': ...
    def settings(self) -> Settings: ...
