...
class View:
    ...
    def lines(self, r: Region) -> [Region]: ...
    def split_by_newlines(self, r: Region) -> [Region]: ...
    def line(self, x: Union[Region, int]) -> Region: ...
    def full_line(self, x: Union[Region, int]) -> Region: ...
    def word(self, x: Untion[Region, int]) -> Region: ...
    ...
    def viewport_position(self) -> (int, int): ...
    def set_viewport_position(self, xy: (int, int), animate: bool = ...) -> None: ...
    def viewport_extent(self) -> (int, int): ...
    def layout_extent(self) -> (int, int): ...
    def text_to_layout(self, tp: int) -> (int, int): ...
    def layout_to_text(self, xy: (int, int)): ...
    def window_to_layout(self, xy: (int, int)) -> (int, int): ...
    def window_to_text(self, xy: (int, int)) -> int: ...
